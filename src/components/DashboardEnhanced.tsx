...
import { 
  Wallet, CreditCard, PiggyBank, TrendingUp, Target, 
  Sparkles, ShieldCheck, LayoutDashboard, PieChart,
  DollarSign, Percent, Activity, BarChart3
} from 'lucide-react';
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white rounded-xl p-5 shadow-sm border border-zinc-100 hover:shadow-md transition-shadow">
      ...
      {totalIncome > 0 && (
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-zinc-100">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h4 className="text-lg font-bold text-zinc-900">Financial Health Score</h4>
              <p className="text-sm text-zinc-500">Your financial wellness at a glance</p>
            </div>
          </div>
