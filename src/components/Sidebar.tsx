...
import { Wallet, CreditCard, PiggyBank, Receipt, User, Target, Shield, Loader2, BrainCircuit, RefreshCcw, Calendar, DollarSign, Info, Home, Car, Utensils, Tv, MoreHorizontal } from 'lucide-react';
...
export const Sidebar: React.FC<Props> = ({ data, onChange, goal, onGoalChange, onAnalyze, loading, isMobile }) => {
  ...
  const handleExpenseChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const totalExpenses = Object.values(newBreakdown).reduce((sum, val) => sum + val, 0);
  ...
  const containerClasses = isMobile 
    ...
    : "w-full lg:w-80 xl:w-96 bg-white border-r border-zinc-200 h-screen sticky top-0 overflow-y-auto p-6 space-y-8 hidden lg:block";
